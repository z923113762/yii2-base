...
class m150426_041420_comment extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk_comment_section', self::TBL_NAME, '[[section_id]]', '{{%section}}', '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_comment_parent', self::TBL_NAME, '[[parent]]', self::TBL_NAME, '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_comment_createdby', self::TBL_NAME, '[[created_by]]', '{{%user}}', '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_comment_updatedby', self::TBL_NAME, '[[updated_by]]', '{{%user}}', '[[id]]', 'RESTRICT', 'CASCADE');
    }
