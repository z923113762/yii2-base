...
class m150426_041259_section extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk_section_parent', self::TBL_NAME, '[[parent]]', self::TBL_NAME, '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_section_ancestor', self::TBL_NAME, '[[ancestor]]', self::TBL_NAME, '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_section_next', self::TBL_NAME, '[[next]]', self::TBL_NAME, '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_section_prev', self::TBL_NAME, '[[prev]]', self::TBL_NAME, '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_section_createdby', self::TBL_NAME, '[[created_by]]', '{{%user}}', '[[id]]', 'RESTRICT', 'CASCADE');
        $this->addForeignKey('fk_section_updatedby', self::TBL_NAME, '[[updated_by]]', '{{%user}}', '[[id]]', 'RESTRICT', 'CASCADE');
    }
